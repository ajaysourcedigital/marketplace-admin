  ...
  >
    ...
    >
            ...
            >
              <q-list class="">
                ...
                <q-item-label
                  ...
                  class="text-center"
                >
                  {{ favorites_list.length }} Favorites
                </q-item-label>
      ...
      <div class="col-lg-8 q-pl-md col-md-8 col-sm-12 col-xs-12">
        <q-card
          class="no-border no-border"
          :style="{'height':size['height']-24+'px !important; border-radius: 10px;'}"
        >
          ...
          >
            ...
            <q-item-section>
              <q-item-label lines="1">
                {{ selected_contact.secondary_phone }}
              </q-item-label>
              <q-item-label
                caption
                class="text-grey-8"
          ...
          >
            ...
            <q-item-section>
              <q-item-label lines="1">
                {{ selected_contact.company_email }}
              </q-item-label>
              <q-item-label
                caption
                class="text-grey-8"
